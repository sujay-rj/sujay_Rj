...
import { userLogin, userSignup } from '../../server/api.js';
        ...
        <>
            <header className='container'>
                <div className="hamMenuIcon" id='hamMenuIcon'>
                    <a href="javascript:void(0);" onClick={hamburgerFun} id='hamburgerMenu'>
                        <MenuRoundedIcon fontSize='large' style={{color: "black"}} className='hamburgericon' />
                    </a>
                </div>
                <div className="closeMenuIcon" id='closeMenuIcon'>
                    <a href="javascript:void(0);" onClick={closeFun} id='hamburgerMenu' fontSize='large' style={{color: "black"}}>
                        <CloseIcon />
                    </a>
                </div>
